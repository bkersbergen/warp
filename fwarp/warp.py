...
def find_best_spline(func1, func2, x, interior_knots, cost=None , log=False,
                     optimization_method='Powell', to_return='function',
                     optimization_options=None, starting_weights=None):
    ...
    knot_points = [(i + 1)/(interior_knots + 1) for i in range(interior_knots)]
    ...
    if starting_weights is None:
        ...
        starting = np.concatenate((starting_weights['warp'], starting_weights['scale']))
